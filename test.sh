...
# python dvp_video_consistency.py --max_epoch 50 --input demo/consistency/colorization_user_provided/goat_input --processed demo/consistency/colorization_user_provided/goat_processed --task colorization --with_IRT 1 --IRT_initialization 1 --output result/colorization
